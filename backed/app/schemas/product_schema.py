...
class ProductSchema(BaseModel):
    ...
    size: Optional[str] = Field(default=None, description="Tamaño, talla o dimensiones del producto")
    colors: Optional[str] = Field(default=None, description="Colores disponibles (JSON array o texto separado por comas)")
    launch_year: Optional[int] = Field(default=None, ge=1900, le=2100, description="Año de lanzamiento del producto")
    sku: Optional[str] = Field(default=None, description="Código SKU específico del producto")
