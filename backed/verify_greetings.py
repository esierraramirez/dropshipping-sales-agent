...
for idx, row in availability_tests.iterrows():
    ...
    # El saludo correcto debe contener "asistente" o "Soy el" o similar
...
print('='*100)
print(f'RESULTADO: {correct_greetings}/{len(availability_tests)} saludos respondidos correctamente')
print(f'Porcentaje: {correct_greetings/len(availability_tests)*100:.1f}%')

if correct_greetings == len(availability_tests):
    print('\n✅ TODOS LOS SALUDOS FUERON RESPONDIDOS CORRECTAMENTE')
else:
    print(f'\n❌ {len(availability_tests) - correct_greetings} SALUDOS NO FUERON RESPONDIDOS CORRECTAMENTE')
